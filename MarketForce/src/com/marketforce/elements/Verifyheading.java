...
public class Verifyheading extends ElementBase{
	...
	public Object[][] isExist(){
		...
		ConsoleLogs.PrintBoundry();
		ConsoleLogs.PrintLogs("TestCaseName Is :","isExist");
		return SuiteUtility.GetTestDataUtility(FilePath, "isExist");	
		}
	
	
	
	
	@Test(dataProvider="isExist",priority=1)
		public void textIsVisible(String TestCaseId,String PageName,String boxName,String xPath,String PageUrl,String input) throws InterruptedException{
		
			ConsoleLogs.PrintBoundry();
			ConsoleLogs.PrintLogs(PageName+"_"+boxName+"_"+TestCaseId, "Test Case Started");
			GetUrl.hitUrl(driver,PageUrl);	
			System.out.println("aaaa");
			status=CoreFunctions.CheckExsist(driver, element, xPath,input);
