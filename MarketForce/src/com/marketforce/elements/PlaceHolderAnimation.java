...
public class PlaceHolderAnimation extends ElementBase{
	...
	public Object[][] Animation(){
		...
		ConsoleLogs.PrintBoundry();
		ConsoleLogs.PrintLogs("TestCaseName Is :","Animation");
		return SuiteUtility.GetTestDataUtility(FilePath, "Animation");	
		}
	
	
	
	
	@Test(dataProvider="Animation",priority=1)
		public void testHeaderTextBox(String TestCaseId,String PageName,String boxName,String xPath,String PageUrl,String input) throws InterruptedException{
		
			ConsoleLogs.PrintBoundry();
			ConsoleLogs.PrintLogs(PageName+"_"+boxName+"_"+TestCaseId, "Test Case Started");
			GetUrl.hitUrl(driver,PageUrl);	
			status=CoreFunctions.typeAndCheckClass(driver, element, xPath,input);
